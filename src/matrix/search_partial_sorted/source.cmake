...
set(SEARCH_PARTIAL_SORTED_MATRIX_SRCS ${SEARCH_PARTIAL_SORTED_MATRIX_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/search_partial_sorted_test.cc
)
...
add_executable(search_partial_sorted_matrix ${SEARCH_PARTIAL_SORTED_MATRIX_SRCS})
target_link_libraries(search_partial_sorted_matrix gtest_main)
...
target_compile_features(search_partial_sorted_matrix PRIVATE cxx_std_11)
add_style_check(search_partial_sorted_matrix
  EXCLUDE_DIRS gtest
)
