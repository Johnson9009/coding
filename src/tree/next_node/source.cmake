...
set(NEXT_NODE_OF_BINARY_TREE_SRCS ${NEXT_NODE_OF_BINARY_TREE_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/next_node_test.cc
)
...
add_executable(next_node_of_binary_tree ${NEXT_NODE_OF_BINARY_TREE_SRCS})
target_link_libraries(next_node_of_binary_tree gtest_main)
...
target_compile_features(next_node_of_binary_tree PRIVATE cxx_std_11)
add_style_check(next_node_of_binary_tree
  EXCLUDE_DIRS gtest
)
