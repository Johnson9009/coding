...
set(RECONSTRUCT_FROM_TRAVERSAL_SRCS ${RECONSTRUCT_FROM_TRAVERSAL_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/reconstruct_from_traversal_test.cc
)
...
add_executable(reconstruct_from_traversal ${RECONSTRUCT_FROM_TRAVERSAL_SRCS})
target_link_libraries(reconstruct_from_traversal gtest_main)
...
target_compile_features(reconstruct_from_traversal PRIVATE cxx_std_11)
add_style_check(reconstruct_from_traversal
  EXCLUDE_DIRS gtest
)
