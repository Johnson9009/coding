...
set(TWO_STACKS_SIMULATE_QUEUE_SRCS ${TWO_STACKS_SIMULATE_QUEUE_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/two_stacks_simulate_test.cc
)
...
add_executable(two_stacks_simulate_queue ${TWO_STACKS_SIMULATE_QUEUE_SRCS})
target_link_libraries(two_stacks_simulate_queue gtest_main)
...
target_compile_features(two_stacks_simulate_queue PRIVATE cxx_std_11)
add_style_check(two_stacks_simulate_queue
  EXCLUDE_DIRS gtest
)
