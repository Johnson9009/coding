...
set(ASSIGNMENT_OPERATOR_SRCS ${ASSIGNMENT_OPERATOR_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/assignment_operator_test.cc
)
...
add_executable(assignment_operator ${ASSIGNMENT_OPERATOR_SRCS})
target_link_libraries(assignment_operator gtest_main)
...
target_compile_features(assignment_operator PRIVATE cxx_std_11)
add_style_check(assignment_operator
  EXCLUDE_DIRS gtest
)
