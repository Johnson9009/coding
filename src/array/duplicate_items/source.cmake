...
set(DUPLICATE_ITEMS_IN_ARRAY_SRCS ${DUPLICATE_ITEMS_IN_ARRAY_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/duplicate_items_test.cc
)
...
add_executable(duplicate_items_in_array ${DUPLICATE_ITEMS_IN_ARRAY_SRCS})
target_link_libraries(duplicate_items_in_array gtest_main)
...
target_compile_features(duplicate_items_in_array PRIVATE cxx_std_11)
add_style_check(duplicate_items_in_array
  EXCLUDE_DIRS gtest
)
