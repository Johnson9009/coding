...
set(REPLACE_SPACE_SRCS ${REPLACE_SPACE_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/replace_space_test.cc
)
...
add_executable(replace_space ${REPLACE_SPACE_SRCS})
target_link_libraries(replace_space gtest_main)
...
target_compile_features(replace_space PRIVATE cxx_std_11)
add_style_check(replace_space
  EXCLUDE_DIRS gtest
)
