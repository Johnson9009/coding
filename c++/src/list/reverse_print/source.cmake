...
set(REVERSE_PRINT_LIST_SRCS ${REVERSE_PRINT_LIST_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/reverse_print_test.cc
)
...
add_executable(reverse_print_list ${REVERSE_PRINT_LIST_SRCS})
target_link_libraries(reverse_print_list gtest_main)
...
target_compile_features(reverse_print_list PRIVATE cxx_std_11)
add_style_check(reverse_print_list
  EXCLUDE_DIRS gtest
)
