...
set(REVERSE_LIST_SRCS ${REVERSE_LIST_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/reverse_test.cc
)
...
add_executable(reverse_list ${REVERSE_LIST_SRCS})
target_link_libraries(reverse_list gtest_main)
...
target_compile_features(reverse_list PRIVATE cxx_std_11)
add_style_check(reverse_list
  EXCLUDE_DIRS gtest
)
